...
def send_message(msg, sender_id):
    tocken = '5929925771:AAFUNOFPm6SjNphVGpy0JkDC1ZT9606BHC4'
    url = f'https://api.telegram.org/bot{tocken}/sendMessage?chat_id={sender_id}&text={msg}'
    requests.get(url)


'https://api.telegram.org/bot5929925771:AAFUNOFPm6SjNphVGpy0JkDC1ZT9606BHC4/setWebhook?url=anwlstkd.pythonanywhere.com'
